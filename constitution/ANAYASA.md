...
Dashboard Görevler listesi varsayılan görünümde güncel/aktif görev bağlamına odaklanmalı; canlıya alınmış ve kapalı/geçmiş görevleri veri silmeden görünüm katmanında saklamalıdır. Bu görünürlük checkbox kontrolleriyle geri alınabilir olmalı ve production deploy, secret/env/token/private key, IAM, billing, DNS/firewall, destructive database veya reklam platformu canlı yazma yetkisi anlamına gelmez.
