...
- `standard-report` simülasyon kapısını sadece PASS statusu ile değil, staging/rollback dry-run ve restart/failure static non-mutating kontrat kanıtıyla doğrular
