...
- `web_panel/static/index.html` ana dashboard zemini nötr uygulama arka planıdır; doğa/manzara bitmap arka planı ve `/assets/dashboard-landscape.png` referansı beklenmemelidir.
