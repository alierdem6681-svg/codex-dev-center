...
- Dashboard ana HTML'i `/api/pipeline-flow` payload'unu yatay stage tablariyla gosterir; aktif tab `pipeline_stage` query parametresiyle korunur, polling read-only kalir ve arka planda yavaslar.
