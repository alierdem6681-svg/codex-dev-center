...
- `web_panel/static/index.html` dashboard kabugu notr CSS arka plani kullanir; doga/manzara gorseli arka plan olarak yuklenmemeli ve `/assets/dashboard-landscape.png` geri eklenmemelidir.
